 ...
 * </p>
 */
class NumberPickerTextView extends LinearLayout {
    ...
    interface OnValueChangeListener {
         ...
         */
        void onValueChange(NumberPickerTextView picker, int oldVal, int newVal);
    }
    ...
    interface OnScrollListener {
         ...
         *                    {@link #SCROLL_STATE_IDLE}.
         */
        void onScrollStateChange(NumberPickerTextView view, int scrollState);
    }
     ...
     */
    NumberPickerTextView(Context context) {
        this(context, null);
    }
     ...
     */
    NumberPickerTextView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.stringPickerStyle);
    }
     ...
     */
    NumberPickerTextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);

        // process style attributes
        TypedArray attributesArray = context.obtainStyledAttributes(
                attrs, R.styleable.StringPicker, defStyle, 0);
        final int layoutResId = attributesArray.getResourceId(
                R.styleable.StringPicker_internalLayout, DEFAULT_LAYOUT_RESOURCE_ID);

        mHasSelectorWheel = (layoutResId != DEFAULT_LAYOUT_RESOURCE_ID);

        mSolidColor = attributesArray.getColor(R.styleable.StringPicker_solidColor, 0);

        mSelectionDivider = attributesArray.getDrawable(R.styleable.StringPicker_selectionDivider);
        ...
        mSelectionDividerHeight = attributesArray.getDimensionPixelSize(
                R.styleable.StringPicker_selectionDividerHeight, defSelectionDividerHeight);
        ...
        mSelectionDividersDistance = attributesArray.getDimensionPixelSize(
                R.styleable.StringPicker_selectionDividersDistance, defSelectionDividerDistance);

        mMinHeight = attributesArray.getDimensionPixelSize(
                R.styleable.StringPicker_internalMinHeight, SIZE_UNSPECIFIED);

        mMaxHeight = attributesArray.getDimensionPixelSize(
                R.styleable.StringPicker_internalMaxHeight, SIZE_UNSPECIFIED);
        ...
        mMinWidth = attributesArray.getDimensionPixelSize(
                R.styleable.StringPicker_internalMinWidth, SIZE_UNSPECIFIED);

        mMaxWidth = attributesArray.getDimensionPixelSize(
                R.styleable.StringPicker_internalMaxWidth, SIZE_UNSPECIFIED);
        ...
        mVirtualButtonPressedDrawable = attributesArray.getDrawable(
                R.styleable.StringPicker_virtualButtonPressedDrawable);
        ...
        if (!mHasSelectorWheel) {
            mIncrementButton = (ImageButton) findViewById(R.id.sp__increment);
        ...
        // decrement button
        if (!mHasSelectorWheel) {
            mDecrementButton = (ImageButton) findViewById(R.id.sp__decrement);
     ...
     * <p>
     * If the argument is less than the {@link me.parkerwilliams.stringpicker.NumberPickerTextView#getMinValue()} and
     * {@link me.parkerwilliams.stringpicker.NumberPickerTextView#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link me.parkerwilliams.stringpicker.NumberPickerTextView#getMinValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link me.parkerwilliams.stringpicker.NumberPickerTextView#getMinValue()} and
     * {@link me.parkerwilliams.stringpicker.NumberPickerTextView#getWrapSelectorWheel()} is <code>true</code> the
     * current value is set to the {@link me.parkerwilliams.stringpicker.NumberPickerTextView#getMaxValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link me.parkerwilliams.stringpicker.NumberPickerTextView#getMaxValue()} and
     * {@link me.parkerwilliams.stringpicker.NumberPickerTextView#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link me.parkerwilliams.stringpicker.NumberPickerTextView#getMaxValue()} value.
     * </p>
     * <p>
     ...
     * wrap around the {@link me.parkerwilliams.stringpicker.NumberPickerTextView#getMinValue()} and
     * {@link me.parkerwilliams.stringpicker.NumberPickerTextView#getMaxValue()} values.
     * <p>
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(NumberPickerTextView.class.getName());
    ...
    class PressedStateHelper implements Runnable {
        ...
        void cancel() {
            mMode = 0;
            mManagedButton = 0;
            NumberPickerTextView.this.removeCallbacks(this);
            if (mIncrementVirtualButtonPressed) {
        ...
        void buttonPressDelayed(int button) {
            ...
            NumberPickerTextView.this.postDelayed(this, ViewConfiguration.getTapTimeout());
        }
        ...
        void buttonTapped(int button) {
            ...
            mMode = MODE_TAPPED;
            mManagedButton = button;
            NumberPickerTextView.this.post(this);
        }
            ...
            switch (mMode) {
                ...
                case MODE_TAPPED: {
                    switch (mManagedButton) {
                        case BUTTON_INCREMENT: {
                            if (!mIncrementVirtualButtonPressed) {
                                NumberPickerTextView.this.postDelayed(this,
    ...
    class AccessibilityNodeProviderImpl extends AccessibilityNodeProvider {
            ...
            switch (virtualViewId) {
                case View.NO_ID: {
                    switch (action) {
                        ...
                        case AccessibilityNodeInfo.ACTION_SCROLL_FORWARD: {
                            if (NumberPickerTextView.this.isEnabled()
                ...
                case VIRTUAL_VIEW_ID_INPUT: {
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_FOCUS: {
                            if (NumberPickerTextView.this.isEnabled() && !mInputText.isFocused()) {
                ...
                case VIRTUAL_VIEW_ID_INCREMENT: {
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_CLICK: {
                            if (NumberPickerTextView.this.isEnabled()) {
                                NumberPickerTextView.this.changeValueByOne(true);
                                sendAccessibilityEventForVirtualView(virtualViewId,
                    ...
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_CLICK: {
                            if (NumberPickerTextView.this.isEnabled()) {
                                ...
                                NumberPickerTextView.this.changeValueByOne(increment);
                                sendAccessibilityEventForVirtualView(virtualViewId,
                                        AccessibilityEvent.TYPE_VIEW_CLICKED);
                                return true;
                            }
        ...
        private void sendAccessibilityEventForVirtualText(int eventType) {
            if (((AccessibilityManager) getContext().getSystemService(Context.ACCESSIBILITY_SERVICE)).isEnabled()) {
                ...
                event.setSource(NumberPickerTextView.this, VIRTUAL_VIEW_ID_INPUT);
                requestSendAccessibilityEvent(NumberPickerTextView.this, event);
            }
        }
        ...
        private void sendAccessibilityEventForVirtualButton(int virtualViewId, int eventType,
            ...
            if (((AccessibilityManager) getContext().getSystemService(Context.ACCESSIBILITY_SERVICE)).isEnabled()) {
                ...
                event.setEnabled(NumberPickerTextView.this.isEnabled());
                event.setSource(NumberPickerTextView.this, virtualViewId);
                requestSendAccessibilityEvent(NumberPickerTextView.this, event);
            }
        }
        ...
        private AccessibilityNodeInfo createAccessibiltyNodeInfoForInputText() {
            ...
            info.setSource(NumberPickerTextView.this, VIRTUAL_VIEW_ID_INPUT);
        ...
        private AccessibilityNodeInfo createAccessibilityNodeInfoForVirtualButton(int virtualViewId,
            ...
            info.setSource(NumberPickerTextView.this, virtualViewId);
            info.setParent(NumberPickerTextView.this);
            info.setText(text);
            info.setClickable(true);
            info.setLongClickable(true);
            info.setEnabled(NumberPickerTextView.this.isEnabled());
        ...
        private AccessibilityNodeInfo createAccessibilityNodeInfoForNumberPicker(int left, int top,
                                                                                 int right, int bottom) {
            AccessibilityNodeInfo info = AccessibilityNodeInfo.obtain();
            info.setClassName(NumberPickerTextView.class.getName());
            info.setPackageName(getContext().getPackageName());
            info.setSource(NumberPickerTextView.this);

            if (hasVirtualDecrementButton()) {
                info.addChild(NumberPickerTextView.this, VIRTUAL_VIEW_ID_DECREMENT);
            }
            info.addChild(NumberPickerTextView.this, VIRTUAL_VIEW_ID_INPUT);
            if (hasVirtualIncrementButton()) {
                info.addChild(NumberPickerTextView.this, VIRTUAL_VIEW_ID_INCREMENT);
            }
